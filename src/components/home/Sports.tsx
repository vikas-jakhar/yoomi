                            ...
                            {[...Array(6)].map((_, idx) => (
                                <SwiperSlide key={idx}>
                                    <div className="sm:max-w-[152px] rounded w-full overflow-hidden hover:scale-110 transition_slow cursor-pointer">
                                        <Image src={`${idx === 0 ? "/assets/images/webp/sports-img.webp" : "/assets/images/webp/swiper-women-img.webp"}`} className='w-[107px] sm:w-full min-h-[70px] max-h-[70px] sm:min-h-[100px] sm:max-h-[100px] lg:max-h-fit lg:min-h-[114px] h-full' alt='sports' width={1892} height={946} priority />
                                    </div>
                                </SwiperSlide>
                            ))}
                        </Swiper>
