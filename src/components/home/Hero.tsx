...
const Hero = () => {
    return (
        <div className='pt-[26px]'>
            <Header />
            <div className="container pt-24 mt-0.5">
                <h2 className='font-plus max-w-[823px] w-full mx-auto text-center text-custom-2xl leading-custom-2xl font-extrabold'>
                    Next Generation <span className='font-plus font-normal'>Patient Engagement and RTM Solution✨</span>
                </h2>
                <p className='w-fit mx-auto font-inter font-normal text-2xl opacity-70 mt-4'>Industry leading AI motion-tracking technology</p>
                <form id='fromEmail' method="get" className='max-w-[428px] mx-auto w-full p-1.5 bg-white rounded flex justify-between items-center mt-14 shadow-3xl'>
                ...
                <div className="max-w-[500px] w-full z-50 px-5 py-10 hidden bg-white rounded-lg shadow-3xl fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">
                    <form id='fromEmail' method="get" className='mx-auto w-full flex flex-col gap-5 justify-between items-center'>
