                ...
                <div className="flex md:flex-row flex-col justify-between">
                    <div className="max-w-[277px] w-full">
                        <Link href="/" className="w-fit relative z-20 group flex">
                            <Image src="/assets/images/webp/sign-logo.png " alt="logo" className="pointer-events-none transition_slow group-hover:drop-shadow-4xl max-w-[192px] w-full" width={238} height={61} priority />
                        </Link>
