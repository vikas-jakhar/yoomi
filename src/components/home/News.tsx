            ...
            <div className="container">
                <div data-aos='zoom-in' className="bg-deep-blue w-full rounded-[32px] p-5 sm:p-16 md:p-20 relative">
                    <div className="ml-1 relative z-10">
                        <Image data-aos='zoom-in' src='/assets/images/webp/sign-logo.png' className='max-w-[228px] w-full' alt='logo' width={458} height={110} priority />
                    ...
                    <Image src='/assets/images/webp/men-img.png' className='sm:max-w-[300px] max-w-[250px] z-10 w-full top-1/2 -translate-y-1/2 absolute right-2 sm:right-[103px] opacity-70 lg:opacity-100' alt='men-img' width={601} height={644} priority />
                    <Image src='/assets/images/webp/sign-ellipse.png' className='absolute bottom-0 right-0' width={200} height={170} alt='ellipse' priority />
                </div>
