        ...
        <div className="sm:pb-1.5 pb-3.5 pt-[26px]">
            <div className="container">
                <nav className="flex items-center justify-between">
                    ...
                    <div className={`${open ? "left-0 bg-white" : "-left-full"} flex items-center z-30 md:bg-transparent fixed flex-col w-full h-screen justify-center gap-7 top-0 md:relative md:bg-none md:flex-row md:gap-11 md:h-fit md:w-fit md:left-auto transition_slow`}>
                        ...
                        <PrimaryButton text="Get Started" onClick={toggleFormVisibility} />
                    </div>
                    <div role="button" aria-label="menu icon" aria-expanded={open} onClick={ToggleOpen} className={`${open ? "w-9" : "w-7"} h-5 relative overflow-hidden md:hidden flex z-40 cursor-pointer transition_slow`}>
